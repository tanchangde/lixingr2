...
resp_lxr_cn_com_equity_change <- lxr_cn_com_equity_change(
  token = Sys.getenv("LIXINGR_TOKEN"),
  stock_code = "300750",
...
resp_lxr_cn_com_shareholders_num <- lxr_cn_com_shareholders_num(
  token = Sys.getenv("LIXINGR_TOKEN"),
  stock_code = "300750",
...
save_json_response(
  resp_lxr_cn_com_shareholders_num,
