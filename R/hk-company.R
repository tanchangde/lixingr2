...
#' @inherit common_return return
#'
#' @seealso [API documentation](https://www.lixinger.com/open/api/doc?api-key=hk/company/fundamental/bank)
#'
#' @rdname lxr_hk_com_fundmtl_bank
#' @export
...
#' @inherit common_return return
#'
#' @seealso [API documentation](https://www.lixinger.com/open/api/doc?api-key=hk/company/fundamental/security)
#'
#' @rdname lxr_hk_com_fundmtl_security
#' @export
...
#'   a maximum of 128 metrics can be retrieved.
#'
#' @seealso [API documentation](https://www.lixinger.com/open/api/doc?api-key=hk/company/fs/bank)
#'
#' @examples
#' \dontrun{
#' lxr_hk_com_fs_bank(
...
#' }
#'
#' @rdname lxr_hk_com_fs_bank
#' @export
lxr_hk_com_fs_bank <- make_endpoint(
  endpoint = "hk/company/fs/bank",
  required = c("token", "stock_codes", "metrics_list"),
  optional = c("date", "start_date", "end_date", "limit"),
  array_params = c("stock_codes", "metrics_list")
)
