...
1.  Register and log in to lixinger, then acquire a `Token` from the [Open Platform](https://www.lixinger.com/open/api/token).
...
The commit logs for this project follow this [style guide](https://www.conventionalcommits.org/en/v1.0.0/). Please try to adhere to it. The optional scopes are:
